...
public class OkHttpUtils {
    ...
    public static StringBuffer getQueryString(String url,Map<String,String> queries){
        ...
        if (queries != null && queries.keySet().size() > 0) {
            ...
            queryString(iterator,firstFlag,sb);
        }
        return sb;
    }
    /**
    ...
    public static StringBuffer queryString(Iterator iterator,boolean firstFlag,StringBuffer sb){
    ...
    public static String get(String url, JSONObject queries) {
        StringBuffer sb = getQueryString(url,queries);
        Request request = new Request.Builder()
                .url(sb.toString())
                .build();
